...
using System.Data.SqlClient;
	...
	{
		SqlCon Scon = new SqlCon();
		SqlDataAdapter Sqlda = new SqlDataAdapter("spGetListSecurityQuestion",Scon.Open());
	...
	{
		SqlCon Scon = new SqlCon();
		SqlDataAdapter Sqlda = new SqlDataAdapter("spDetailsSecurityQuestion",Scon.Open());
	...
	{
		SqlCon Scon = new SqlCon();
		SqlDataAdapter Sqlda = new SqlDataAdapter("spDetailsByFieldSecurityQuestion",Scon.Open());
		Sqlda.SelectCommand.CommandType = CommandType.StoredProcedure;
